...
phi_max = np.polynomial.polynomial.Polynomial(np.polynomial.polynomial.polyfit(m_A, m_phi, 3))
...
class pF: 
	...
	t = 1e-2
	## Fluid mesh
	# Richardson Zaki exponent for the hindrance effect of the drag force
	expoDrag = 3.1
